...
export default function SingleCard(props) {
  ...
  return (
    <div>
      ...
      { props.equipment.image && ( <Image src={props.equipment.image}  className="mx-auto"
          height="250px"
          width="250px"
          alt="equipment image" /> ) }
        ...
        <div className="px-6 pt-4 pb-2">
          <button
            className="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold h-8 px-2 border border-blue-700 rounded"
            onClick={() => dispatch(addItem(props.equipment))}
          >
            Add to cart
          </button>
          ...
          <button
            className="bg-red-500 hover:bg-red-700 text-white text-sm font-bold h-8 px-2 border border-red-700 rounded"
            onClick={() => handleDelete(props.equipment.id)}
          >
            Delete
          </button>
        </div>
